 ...
 */
public class HuaYuFfTask extends TmallApplicationTests {
    ...
    public void execute() throws Exception {
        ...
        List<Properties> list = new ArrayList<Properties>(){{
            add(new Properties("华宇分分", ThirteenNum66, finalNextqh,6,6,"Q 和9 13 夸2 胆12345678", client, map));
            add(new Properties("华宇分分", EightNum66, finalNextqh,6,6,"Q 和8 10 跨0 定0 胆012345679", client, map));
            add(new Properties("华宇分分", ElevenNum66, finalNextqh,6,6,"Q 和11 夸1 胆23456789 定6", client, map));
            add(new Properties("华宇分分", SevenNum66, finalNextqh,6,6,"Q 和7 夸3 定2 胆1245689", client, map));
            add(new Properties("华宇分分", sixNum66, finalNextqh,6,6,"Q 和6 跨0 4 定9", client, map));
            add(new Properties("华宇分分", TwelveNum66, finalNextqh,6,6,"W 和12 跨0 5 定1", client, map));
            add(new Properties("华宇分分", Twelve2Num66, finalNextqh,6,6,"W 和12 跨0 1", client, map));
            add(new Properties("华宇分分", FourNum66, finalNextqh,6,6,"W 和4 14 跨1 胆1235689", client, map));
        }};

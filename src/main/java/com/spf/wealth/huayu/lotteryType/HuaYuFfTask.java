...
//            add(new Properties("华宇分分", sixNum66, finalNextqh, h_bz_num, q_bz_num,"Q 和6 跨0 4 定9", client, map));
//            add(new Properties("华宇分分", TwelveNum66, finalNextqh, h_bz_num, q_bz_num,"W 和12 跨0 5 定1", client, map));
//            add(new Properties("华宇分分", Twelve2Num66, finalNextqh, h_bz_num, q_bz_num,"W 和12 跨0 1", client, map));
//            add(new Properties("华宇分分", FourNum66, finalNextqh, h_bz_num, q_bz_num,"W 和4 14 跨1 胆1235689", client, map));
        }};

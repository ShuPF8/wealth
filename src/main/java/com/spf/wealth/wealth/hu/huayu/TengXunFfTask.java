...
public class TengXunFfTask {
    ...
    public void execute() throws Exception {
        ...
        Properties sevenProperties = new Properties("腾讯分分", SevenNum,nextqh,7,7,"和7,11", client, map);
        Properties nineProperties = new Properties("腾讯分分", NineNum,nextqh,7,7,"和9,11", client, map);
        Properties tenProperties = new Properties("腾讯分分", TenNum,nextqh,7,7,"和8,10", client, map);
        Properties ntProperties = new Properties("腾讯分分", NTnum,nextqh,7,7,"和9,10", client, map);
        Properties sixProperties = new Properties("腾讯分分", sixNum,nextqh,7,7,"和6,12", client, map);

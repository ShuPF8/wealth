 ...
 * @author ShuPF
 * @类说明：
 * @date 2018-09-13 14:06
 */
public class WanDaFfTask {
    ...
    private WanDaFf tengXunFf = new WanDaFf();
    ...
    public void execute() throws Exception {
        ...
        Properties sevenProperties = new Properties("华宇分分", SevenNum,nextqh,6,6,"和7,11");
        Properties nineProperties = new Properties("华宇分分", NineNum,nextqh,6,6,"和9,11");
        Properties tenProperties = new Properties("华宇分分", TenNum,nextqh,6,6,"和8,10");
